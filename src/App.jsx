    ...
    <BorrowProvider>
      <StoreProvider>
        <div className="flex flex-col min-h-screen">
          {/* Header: Full-width, shown only on home */}
          {isHomePage && <Header />}

          <div className="flex flex-1">
            {/* Sidebar: Shown only on home, slimmer */}
            {isHomePage && (
              <>
                {isSidebarOpen && (
                  <div
                ...
                <aside
                  ...
                  } md:translate-x-0 z-10 border-l border-purple-200`}
                >
                  <Sidebar />
                </aside>
              </>
            ...
            <div className={`flex-1 ${isHomePage ? "md:ml-32 mt-12" : ""}`}>
              ...
              {isHomePage && (
                <button
                  className="md:hidden p-2 bg-purple-700 text-white fixed top-2 left-2 z-20"
