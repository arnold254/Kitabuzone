...
Revision ID: 6b1e5d5e4269
Revises: 
Create Date: 2025-09-25 13:23:11.557730
...
def upgrade():
    ...
    sa.Column('is_available', sa.Enum('available', 'unavailable', name='book_availability'), nullable=True),
    sa.Column('is_library_copy', sa.Boolean(), nullable=True),
    ...
    sa.Column('id', sa.String(length=50), nullable=False),
    sa.Column('lending_request_id', sa.String(length=50), nullable=False),
    sa.Column('user_id', sa.String(length=50), nullable=False),
    sa.Column('book_id', sa.String(length=50), nullable=False),
